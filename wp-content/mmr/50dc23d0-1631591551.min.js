...
maybePreventBeforeUnload();__gtagTrackerHitBackRun=!0;window.location.href=link};var __gtagTrackerNoRedirectExternal=function(){valuesArray.exit='external';__gtagTrackerNotSend(valuesArray)};var __gtagTrackerNoRedirectInboundAsExternal=function(){valuesArray.exit='internal-as-outbound';__gtagTrackerNotSend(valuesArray)};var __gtagTrackerNoRedirectCrossHostname=function(){valuesArray.exit='cross-hostname';__gtagTrackerNotSend(valuesArray)};if(target||type=='mailto'||type=='tel'){if(type=='download'){fieldsArray={event_category:'download',event_label:label||valuesArray.title,}}else if(type=='tel'){fieldsArray={event_category:'tel',event_label:label||valuesArray.title.replace('tel:',''),}}else if(type=='mailto'){console.log(label||valuesArray.title.replace('mailto:',''));fieldsArray={event_category:'mailto',event_label:label||valuesArray.title.replace('mailto:',''),}}else if(type=='internal-as-outbound'){fieldsArray={event_category:internalAsOutboundCategory,event_label:label||valuesArray.title,}}else if(type=='external'){fieldsArray={event_category:'outbound-link',event_label:label||valuesArray.title,}}else if(type=='cross-hostname'){fieldsArray={event_category:'cross-hostname',event_label:label||valuesArray.title,}}
if(fieldsArray){__gtagTrackerSend('event',action||link,fieldsArray,valuesArray)}else{if(type&&type!='internal'){fieldsArray={event_category:type,event_label:label||valuesArray.title,};__gtagTrackerSend('event',action||link,fieldsArray,valuesArray)}else{valuesArray.exit='type';__gtagTrackerNotSend(valuesArray)}}}else{if(type!='cross-hostname'&&type!='external'&&type!='internal-as-outbound'){if(!event.defaultPrevented){if(event.preventDefault){event.preventDefault()}else{event.returnValue=!1}}}
if(type=='download'){fieldsArray={event_category:'download',event_label:label||valuesArray.title,event_callback:__gtagTrackerHitBack,};__gtagTrackerSend('event',action||link,fieldsArray,valuesArray)}else if(type=='internal-as-outbound'){beforeUnloadChanged=!0;window.onbeforeunload=function(e){if(!event.defaultPrevented){if(event.preventDefault){event.preventDefault()}else{event.returnValue=!1}}
...
__gtagTrackerSend('event',action||link,fieldsArray,valuesArray);setTimeout(__gtagTrackerHitBack,1000)}}else if(type=='external'){beforeUnloadChanged=!0;window.onbeforeunload=function(e){if(!event.defaultPrevented){if(event.preventDefault){event.preventDefault()}else{event.returnValue=!1}}
...
__gtagTrackerSend('event',action||link,fieldsArray,valuesArray);setTimeout(__gtagTrackerHitBack,1000)}}else if(type=='cross-hostname'){beforeUnloadChanged=!0;window.onbeforeunload=function(e){if(!event.defaultPrevented){if(event.preventDefault){event.preventDefault()}else{event.returnValue=!1}}
...
var prevHash=window.location.hash;function __gtagTrackerHashChangeEvent(){if(exactmetrics_frontend.hash_tracking==="true"&&prevHash!=window.location.hash&&exactmetrics_frontend.ua){prevHash=window.location.hash;__gtagTracker('config',exactmetrics_frontend.ua,{page_path:location.pathname+location.search+location.hash,})
